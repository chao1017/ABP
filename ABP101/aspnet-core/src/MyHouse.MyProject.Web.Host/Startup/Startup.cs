...
using MyHouse.MyProject.Identity;
...
namespace MyHouse.MyProject.Web.Host.Startup
{
        ...
        public void Configure(IApplicationBuilder app,  ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("MyHouse.MyProject.Web.Host.wwwroot.swagger.ui.index.html");
            }); // URL: /swagger
        }
    }
}
