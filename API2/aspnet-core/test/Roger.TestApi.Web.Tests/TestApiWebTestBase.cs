...
using Roger.TestApi.Models.TokenAuth;
...
{
    public abstract class TestApiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TestApiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TestApiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TestApiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TestApiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TestApiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TestApiDbContext, Task<T>> func)
        {
            T result;
