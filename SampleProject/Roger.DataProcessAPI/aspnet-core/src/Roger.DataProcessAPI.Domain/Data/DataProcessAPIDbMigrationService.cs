...
{
    public class DataProcessAPIDbMigrationService : ITransientDependency
    {
        public ILogger<DataProcessAPIDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IDataProcessAPIDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public DataProcessAPIDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IDataProcessAPIDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<DataProcessAPIDbMigrationService>.Instance;
        }
